...
const FlowbiteHtmlDatepicker = ({ value, onChange,onBlur, name,  placeholder = "date", range = false, mode = 'day' }) => {
  ...
  return (
    <div className="relative z-[9999]">
      ...
      type="text"
      name={name}
      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-200 dark:border-gray-400 dark:placeholder-gray-500 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 z-[9999]"
