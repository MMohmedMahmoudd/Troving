...
const ReservationsContent = () => {
  ...
  const columns = useMemo(() => [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <span className={`badge badge-outline ${row.original.status_name === 'Completed' ? 'badge-success' : row.original.status_name === 'Active' ? 'badge-success' : row.original.status_name === 'Cancelled' ? 'badge-error' : row.original.status_name === 'Waiting Payment' ? 'badge-primary' : row.original.status_name === 'Waiting Confirmation' ? 'badge-warning' : row.original.status_name === 'Waiting Confirmation from Customer' ? 'badge-warning': ""} `}>
