          ...
          {bundles.map((bundle) => (
            <div key={bundle.bundle_uid} className="card rounded-lg shadow p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600">
                  <span className="font-medium">Usage Time:</span> {bundle.bundle_usage_time} hours
                </p>
                <p className="text-gray-600">
              ...
              <div className='mt-4'>
                <button className='btn btn-outline btn-primary w-full flex justify-center items-center'>Edit</button>
              </div>
            </div>
          ))}
        </div>
