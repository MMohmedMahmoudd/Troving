                    ...
                    <div className="flex flex-col w-full">
                        <div className="flex justify-between ">
                            <div className="text-center">
                                <p className="text-3xl font-bold">{offerEn.offer_copouns_qty}</p>
              ...
              <TabPanel value="en">
                <div className="space-y-6 mt-4 w-full">
                  <div>
                    ...
                    <p className="text-gray-600">{offerEn.description}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium mb-2">Offer Highlights</h3>
                    <p className="text-gray-600">{offerEn.offer_highlights}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium mb-2">Inclusions</h3>
                    <p className="text-gray-600">{offerEn.offer_inclusions}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium mb-2">Exclusions</h3>
                    <p className="text-gray-600">{offerEn.offer_exclusions}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium mb-2">Cancellation Policy</h3>
                    <p className="text-gray-600">{offerEn.offer_cancel_policy}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium mb-2">Terms & Conditions</h3>
                    <p className="text-gray-600">{offerEn.offer_terms_conditions}</p>
                  </div>
                </div>
              </TabPanel>
              <TabPanel value="ar">
                <div className="space-y-6 mt-4 w-full">
                  <div>
                    ...
                    <p className="text-gray-600 text-right">{offerAr.description}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium mb-2 text-right">مميزات العرض</h3>
                    <p className="text-gray-600 text-right">{offerAr.offer_highlights}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium mb-2 text-right">المشتملات</h3>
                    <p className="text-gray-600 text-right">{offerAr.offer_inclusions}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium mb-2 text-right">الاستثناءات</h3>
                    <p className="text-gray-600 text-right">{offerAr.offer_exclusions}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium mb-2 text-right">سياسة الإلغاء</h3>
                    <p className="text-gray-600 text-right">{offerAr.offer_cancel_policy}</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium mb-2 text-right">الشروط والأحكام</h3>
                    <p className="text-gray-600 text-right">{offerAr.offer_terms_conditions}</p>
                  </div>
                </div>
              </TabPanel>
            </Tabs>
